      ...
      >
        ...
        <div class="Pre-screening-text"><h2>Pre-Screening</h2>
          <div class="four-routes-images">
              <a class="" href="/add/phase1" style="padding: 0px 10px;">
              ...
              <a class="" href="/report/view" style="padding: 0px 10px;">
                <div class="books-img"> 
                  <img src="/assets/view-report-icon-b9b82219.svg" alt="" class="books"/>
                  <p class="add-report-text">View Report</p>
                </div>
              </a>
              <a class="" href="/admin/linkcompany/view" style="padding: 0px 10px;">
                <div class="link-img">
