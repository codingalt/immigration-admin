...
const LinkCOmpany = () => {
        ...
        const initialValues = app && {
          ...
          phase1: {
            ...
            refusedVisaDate:
              app &&
              format(new Date(app?.phase1?.refusedVisaDate), "yyyy-MM-dd"),
        ...
        const {isLoading: loadingCompany, isSuccess: successCompany, error: errorCompany} = resultCompany
    ...
    return (
      <div className="Phase-1-main-container">
        ...
        <div className="Copmany-slection">
          <Formik
            initialValues={linkCompanyInitial}
                ...
                <>
                  ...
                  <div className="right-side-company-selection">
                    ...
                    <div className="Link-company-buttons">
                      ...
                      <button disabled={loadingCompany} style={{cursor:"pointer",display:"flex",justifyContent:"center",alignItems:"center"}} type="submit" className="link-company-btn">
