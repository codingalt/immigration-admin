...
const Phase1 = () => {
  ...
  const initialValues = app && {
    ...
    phase1: {
      ...
      temporaryVisaDetails: app && app?.phase1?.temporaryVisaDetails,
      temporaryVisaValidUntill: app && app?.phase1?.temporaryVisaValidUntill,
                ...
                <div className="left-side-forget-password-2">
                  ...
                  <div className="phase-1-form">
                    ...
                    <div className="nationalty-input">
                      ...
                      {app?.phase1.temporaryVisaDetails && (
                        <>
                          <p className="phase-1-text-left-side">
                      ...
                      {app?.phase1.temporaryVisaValidUntill && (
                        <div className="Date-input">
                          <p className="phase-1-text-left-side">
                           Valid Untill
                          </p>
