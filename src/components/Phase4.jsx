...
const handleBackClick = () => {
  ...
  return (
    <div className='Phase-2-main-container'>
      ...
      <div className='gernral-main'>
        <form action="">
          <div className='left-side-general'>


            <p className='genral-text-left-side'>1.Full Name*</p>
            <input type="text" className='genral-input-left-side' placeholder='Jhon Leo' />
            <p className='genral-text-left-side'>2.Have you been known by any other names ?*</p>
            ...
            <select class="form-select" placeholder='Select Country' className='genral-input-left-side' >
            ...
            <p className='genral-text-left-side'>6.Any other Nationalities ?</p>
            ...
            <p className='genral-text-left-side'>i. Other Nationality*</p>
            <select class="form-select" placeholder='Select Country' className='genral-input-left-side'   >
              <option>Search Country</option>
              <option value="AF">Afghanistan</option>
              <option value="AX">Aland Islands</option>
            ...
            <p className='genral-text-left-side'>7.Current passport number*</p>
            <select class="form-select" placeholder='Select Country' className='genral-input-left-side' >
              <option>Search Country</option>
              <option value="AF">7700225VH</option>
              <option value="AX">5452407DH</option>
              <option value="AL">1241125LH</option>
              <option value="DZ">6993459TH</option>
              <option value="AS">4115381JA</option>
              <option value="AD">8268048MA</option>
              <option value="AO">4835734QA</option>
              <option value="AI">9857460SH</option>
              <option value="AQ">7141506RA</option>
            </select>
            ...
            <input type="text" className='genral-input-left-side' placeholder='Issuing autority' />
            ...
            <p className='genral-text-left-side'>12.Do you have a national ID card for your country of nationality ?*</p>
...
<div className='checkbox-phase1'>
  ...
  <input type="text" className='genral-input-right-side' placeholder='Jhon Leo' />

  <p  className='genral-text-right-side'>iii. Date of issue*</p>
  <input type="date" className='genral-input-right-side' name="" id="" />
  <p className='genral-text-right-side'>13.Name of Mother*</p>
  <input type="text" className='genral-input-right-side' placeholder='Jhon Leo' />

          </div>
          
          <button className='Download-button-general'>Download</button>

          <div className='right-side-genral'>
              ...
              <select class="form-select" placeholder='Select' className='genral-input-right-side' >
              ...
              <p className='genral-text-right-side'>17.Mother's Place of Birth*</p>
              <select class="form-select" placeholder='Select' className='genral-input-right-side'  >
                <p className='select-country-11' >16.Select Country*</p>
                <option>Select</option>
                <option value="AF">Afghanistan</option>
              ...
              <p className='genral-text-right-side'>22.Father's Place of Birth*</p>
              <select class="form-select" placeholder='Select'  className='genral-input-right-side'  >
                <p className='select-country-11' >16.Select Country*</p>
                <option>Select</option>
                <option value="AF">Afghanistan</option>
              ...
              <p className='genral-text-right-side'>23.Do you have a UK NI Number ?*</p>
              ...
              <p className='genral-text-right-side'>24.Do you have a UK driving license ?*</p>
              ...
              <p className='genral-text-right-side'>i. UK driving license Number*</p>
              <input type="text"  className='genral-input-right-side'placeholder='Jhon Leo' />
