...
import { usePostGroupLanguageMutation } from "../../services/api/companyClient";

const LanguageProficiencyFormGroup = ({
  data,
  setActiveTab,
  initialValues,
  refetch,
  ...
  const [postGroupLanguage, res] = usePostGroupLanguageMutation();
...
export default LanguageProficiencyFormGroup;
