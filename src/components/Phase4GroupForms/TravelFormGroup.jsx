...
import { usePostGroupTravelMutation } from "../../services/api/companyClient";

const TravelFormGroup = ({
  data,
  setActiveTab,
  initialValues,
  setLastVisitsToUk,
  ...
  const [postGroupTravel, res] = usePostGroupTravelMutation();
...
export default TravelFormGroup;
