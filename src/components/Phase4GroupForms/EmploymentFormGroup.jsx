...
import { usePostGroupEmploymentMutation } from "../../services/api/companyClient";

const EmploymentFormGroup = ({
  data,
  setActiveTab,
  initialValues,
  refetch,
...
export default EmploymentFormGroup;
