...
import { usePostGroupMaintenanceMutation } from "../../services/api/companyClient";

const MaintenanceFormGroup = ({
  data,
  setActiveTab,
  initialValues,
  refetch,
  ...
  const [postGroupMaintenance, res] =
...
export default MaintenanceFormGroup;
