...
import { useApprovePhase4Mutation, useGetApplicationByUserIdQuery, useGetApplicationDataByIdQuery } from "../services/api/applicationApi";
...
const Phase4Page = () => {
  ...
  const { data, refetch } = useGetApplicationDataByIdQuery(applicationId);
         ...
         phase4: {
           ...
           maintenance: {
             ...
             isRegisteredFinancialInstitute: isRegisteredFinancialInstitute
               ...
               : "",
             countryFundsHeldIn: countryFundsHeldIn ? countryFundsHeldIn : "",
             currencyFundsHeldIn: currencyFundsHeldIn
               ? currencyFundsHeldIn
               : "",
             amountHeld: amountHeld ? amountHeld : "",
             fundsDateHeldFrom: fundsDateHeldFrom
